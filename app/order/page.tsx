...
export default function OrderPage() {
  ...
  return (
    <div className="min-h-screen bg-[#EEE1CF] flex items-center justify-center">
      ...
      >
        <p className="text-[2.5rem] px-6 py-3 mb-10 bg-[#e7be39] w-[114.5%] text-white text-2xl text-center shadow-2xl flex justify-center items-center rounded-t-1xl">
          <span className="flex-grow text-center">New Collection</span>{" "}
        </p>
